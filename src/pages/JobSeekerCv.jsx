...
import TechOrProgrammingLangService from '../services/technologiesOrProgrammingLanguagesService';
...
export default function EmployeeCv() {
    ...
    useEffect(() => {
        ...
        cvService.getCvByCvId(cvId).then(result => setCv(result.data.data))
    }, [])
    ...
    return (
        <div>
            <Card>
                ...
                <Card.Content>
                    <Card.Header>{cv.jobSeeker?.firstName}</Card.Header>
                    <Card.Meta>
